...
folder_demand <- "/Users/mphonkadimeng/ (Archive)/Documents/GitHub/LeakDB/CCWI-WDSA2018/Benchmarks/Hanoi_CMH/Scenario-1/Demands"
...
dem_nam <- replicate(33, "Scenario1_Demand_Node_") #New names for coulmn
...
folder_pressure <- "/Users/mphonkadimeng/ (Archive)/Documents/GitHub/LeakDB/CCWI-WDSA2018/Benchmarks/Hanoi_CMH/Scenario-1/Pressures"
...
pressure_data1 <- cbind(pressure_data$Timestamp...1, pressure_data1)#reattach timestamp columns 
pressure_data1 <- subset(pressure_data1, select = -c(1))
...
pressure_nam <- replicate(32, "Scenario1_Pressure_Node_") #New names for coulmns
...
flow_folder1 <- "/Users/mphonkadimeng/ (Archive)/Documents/GitHub/LeakDB/CCWI-WDSA2018/Benchmarks/Hanoi_CMH/Scenario-1/Flows"
...
flow_nam <- replicate(34, "Scenario1_Flow_Link_") #New names for coulmn
...
head(demand_data1$Scenario1_Demand_Node_1)
View(flow1_data)

View(demand_data1)
View(pressure_data1)

sc1_data <- cbind(demand_data1, flow1_data, pressure_data1)
